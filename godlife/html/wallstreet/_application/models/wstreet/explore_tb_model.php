...
class Explore_tb_model extends MY_Model {
    ...
    public static $push_srv_map = array(
        '' => '전체',
        'A' => '전체(키움제외)',
        'C' => '초이스',
        'N' => 'NA',
    );
    public function getPushSrvMap() {
        return self::$push_srv_map;
    }
    ...
    public static $inside_map = array(
        'N' => 'N',
        'Y' => 'Y',
    );
    public function getInsideMap() {
