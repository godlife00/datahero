...
class Recommend_tb_model extends MY_Model {
    ...
    public static $portfolio_map = array(
        'Y' => 'YES',
        'N' => 'NO',
    );

    public static $adjust_map = array(
        '' => '선택',
        'U' => '상향',
        'D' => '하향',
    );
    ...
    public function getPortfolioMap() {
        return self::$portfolio_map;
    }

    public function getAdjustMap() {
        return self::$adjust_map;
    }
