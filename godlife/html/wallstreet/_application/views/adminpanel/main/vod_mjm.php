...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		caption_html += "<a href='/adminpanel/main/vod_mjm_detail' class='btn btn-danger btn-xs' style='float:right;margin-left:5px'>";
		...
		caption_html += "</a>";
         ...
         main_grid = jQuery("#jqgrid").jqGrid({
            ...
            sortname : 'vm_id',
            url : "/adminpanel/main/vod_mjm?mode=list",
            editurl : "/adminpanel/main/vod_mjm?mode=edit",
            datatype : "json",
			...
			{"name":"vm_id","index":"vm_id","align":"center","sortable":false,"search":true,"stype":"between","editable":false},
			{"name":"a_loginid","index":"a_loginid","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["eq"]},"editable":false},
			{"name":"vm_title","index":"vm_title","align":"left","sortable":false,"search":true,"searchoptions":{"sopt":["cn"]},"editable":false, "width":"400"},
			{"name":"vm_display_date","index":"vm_display_date","align":"center","sortable":false,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},
            {"name":"vm_view_srv","index":"vm_view_srv","align":"center","sortable":true,"search":true,"stype":"select","searchoptions":{"sopt":["eq"],"value":"<?=$view_srv_map_sel?>"},"editable":true,"edittype":"select","editoptions":{"sopt":["eq"],"value":"<?=$view_srv_map?>"}, "width":"100"},
			{"name":"vm_view_count","index":"vm_view_count","align":"center","sortable":false,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},
			{"name":"vm_is_active","index":"vm_is_active","align":"center","sortable":true,"search":true,"stype":"select","searchoptions":{"sopt":["eq"],"value":"<?=$active_map_sel?>"},"editable":true,"edittype":"select","editoptions":{"sopt":["eq"],"value":"<?=$active_map?>"}, "width":"100"},
            {"name":"vm_pay","index":"vm_pay","align":"center","sortable":true,"search":true,"stype":"select","searchoptions":{"sopt":["eq"],"value":"<?=$pay_map_sel?>"},"editable":true,"edittype":"select","editoptions":{"sopt":["eq"],"value":"<?=$pay_map?>"}, "width":"100"},
			{"name":"vm_created_at","index":"vm_created_at","align":"center","sortable":false,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},
			{"name":"vm_updated_at","index":"vm_updated_at","align":"center","sortable":false,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},
			{"name":"vm_id_from","index":"vm_id_from","viewable":false,"hidden":true},
			{"name":"vm_id_to","index":"vm_id_to","viewable":false,"hidden":true},
			{"name":"vm_display_date_from","index":"vm_display_date_from","viewable":false,"hidden":true},
			{"name":"vm_display_date_to","index":"vm_display_date_to","viewable":false,"hidden":true},
			{"name":"vm_view_count_from","index":"vm_view_count_from","viewable":false,"hidden":true},
			{"name":"vm_view_count_to","index":"vm_view_count_to","viewable":false,"hidden":true},
			{"name":"vm_created_at_from","index":"vm_created_at_from","viewable":false,"hidden":true},
			{"name":"vm_created_at_to","index":"vm_created_at_to","viewable":false,"hidden":true},
			{"name":"vm_updated_at_from","index":"vm_updated_at_from","viewable":false,"hidden":true},
			{"name":"vm_updated_at_to","index":"vm_updated_at_to","viewable":false,"hidden":true}
		],
...
*/
            ...
            onCellSelect: function(id, cell_idx, cell_value){
				...
				var edit_url = '/adminpanel/main/vod_mjm_detail/'+id;
...
jQuery("#jqgrid").jqGrid('navGrid', "#pjqgrid", {
			...
			// date picker
			var date_fields = ['vm_display_date','vm_created_at','vm_updated_at']; 
...
function update_status() {
    ...
    if(ids.length > 0) {
        var url = '/adminpanel/main/vod_mjm?mode=edit';
