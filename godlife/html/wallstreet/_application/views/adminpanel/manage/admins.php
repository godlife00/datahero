...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		var caption_html = "<b><i class='fa fa-table'>&nbsp;&nbsp;Manage Admins</i></b>"; 
		
		caption_html += "<a href='/adminpanel/manage/admins_detail' class='btn btn-danger btn-xs' style='float:right;margin-left:5px'>";
		...
		caption_html += "</a>";
         ...
         main_grid = jQuery("#jqgrid").jqGrid({
            ...
            sortname : 'a_id',
            url : "/adminpanel/manage/admins?mode=list",
            editurl : "/adminpanel/manage/admins?mode=edit",
            datatype : "json",
            shrinkToFit:<?=($this->agent->is_mobile()) ? 'false' : 'true'?>,
            height : 'auto',
            colNames : ['Id','Loginid','Name','Level','Lastlogin At','Created At','Updated At','Lastlogin At_from','Lastlogin At_to','Created At_from','Created At_to','Updated At_from','Updated At_to'],  
			jsonReader : {
			  id: "a_id",
		   	},
            colModel : [
			{"name":"a_id","index":"a_id","align":"center","sortable":true,"search":true,"searchoptions":{"sopt":["eq"]},"editable":false},
			{"name":"a_loginid","index":"a_loginid","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["cn"]},"editable":false},
			{"name":"a_name","index":"a_name","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["cn"]},"editable":false},
			{"name":"a_level","index":"a_level","align":"center","sortable":true,"search":true,"stype":"select","searchoptions":{"sopt":["eq"],"value":":;1:1Level;2:2Level;3:3Level;4:4Level;5:5Level;9:Admin"},"editable":true,"edittype":"select","editoptions":{"sopt":["eq"],"value":":;1:1Level;2:2Level;3:3Level;4:4Level;5:5Level;9:Admin"}},
			{"name":"a_lastlogin_at","index":"a_lastlogin_at","align":"center","sortable":true,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},
			{"name":"a_created_at","index":"a_created_at","align":"center","sortable":false,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},
			{"name":"a_updated_at","index":"a_updated_at","align":"center","sortable":false,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},
			{"name":"a_lastlogin_at_from","index":"a_lastlogin_at_from","viewable":false,"hidden":true},
			{"name":"a_lastlogin_at_to","index":"a_lastlogin_at_to","viewable":false,"hidden":true},
			{"name":"a_created_at_from","index":"a_created_at_from","viewable":false,"hidden":true},
			{"name":"a_created_at_to","index":"a_created_at_to","viewable":false,"hidden":true},
			{"name":"a_updated_at_from","index":"a_updated_at_from","viewable":false,"hidden":true},
			{"name":"a_updated_at_to","index":"a_updated_at_to","viewable":false,"hidden":true}
		],
...
*/
            ...
            onCellSelect: function(id, cell_idx, cell_value){
				...
				var edit_url = '/adminpanel/manage/admins_detail/'+id;
...
jQuery("#jqgrid").jqGrid('navGrid', "#pjqgrid", {
			...
			// date picker
			var date_fields = ['a_lastlogin_at','a_created_at','a_updated_at']; 
...
function set_edit_datepicker(id) {
	var fields = ['a_lastlogin_at','a_created_at','a_updated_at']; 
...
function update_status() {
    ...
    if(ids.length > 0) {
        var url = '/adminpanel/manage/admins?mode=edit';
