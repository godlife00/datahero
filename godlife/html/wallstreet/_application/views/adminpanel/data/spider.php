...
$page_nav["data"]["sub"]["spider"]["active"] = true;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		var caption_html = "<b><i class='fa fa-table'>&nbsp;&nbsp;Data Spider</i></b>"; 
			main_grid = jQuery("#jqgrid").jqGrid({
            caption : caption_html,
            sortname : 'm_ticker',
            url : "/adminpanel/data/spider?mode=list",
            editurl : "/adminpanel/data/spider?mode=edit",
            datatype : "json",
            shrinkToFit:<?=($this->agent->is_mobile()) ? 'false' : 'true'?>,
            height : 'auto',
            colNames : ['Ticker','Usname','Korname','Exchange','Sector','Industry','fairvalue5','fairvalue4','fairvalue3','fairvalue2','fairvalue1','Biz Growth Score','Biz Growth Stars','Biz Safety Score','Biz Safety Stars','Biz Cashflow Score','Biz Cashflow Stars','Biz Moat Score','Biz Moat Stars','Biz Dividend Score','Biz Dividend Stars','Biz Total Score','Sep Date','Close','Marketcap','Netmargin','Pb','Pe','Ps','Roe','Divyield','Eps1','Eps2','Eps3','Eps4','Eps1 Date','Eps2 Date','Eps3 Date','Eps4 Date','Date','fairvalue5_from','fairvalue5_to','fairvalue4_from','fairvalue4_to','fairvalue3_from','fairvalue3_to','fairvalue2_from','fairvalue2_to','fairvalue1_from','fairvalue1_to','Biz Growth Score_from','Biz Growth Score_to','Biz Growth Stars_from','Biz Growth Stars_to','Biz Safety Score_from','Biz Safety Score_to','Biz Safety Stars_from','Biz Safety Stars_to','Biz Cashflow Score_from','Biz Cashflow Score_to','Biz Cashflow Stars_from','Biz Cashflow Stars_to','Biz Moat Score_from','Biz Moat Score_to','Biz Moat Stars_from','Biz Moat Stars_to','Biz Dividend Score_from','Biz Dividend Score_to','Biz Dividend Stars_from','Biz Dividend Stars_to','Biz Total Score_from','Biz Total Score_to','Sep Date_from','Sep Date_to','Close_from','Close_to','Marketcap_from','Marketcap_to','Netmargin_from','Netmargin_to','Pbr_from','Pbr_to','Per_from','Per_to','Psr_from','Psr_to','Roe_from','Roe_to','Divyield_from','Divyield_to','Eps1_from','Eps1_to','Eps2_from','Eps2_to','Eps3_from','Eps3_to','Eps4_from','Eps4_to','Eps1 Date_from','Eps1 Date_to','Eps2 Date_from','Eps2 Date_to','Eps3 Date_from','Eps3 Date_to','Eps4 Date_from','Eps4 Date_to','Date_from','Date_to'],  
			jsonReader : {
			  id: "m_ticker",
		   	},
            colModel : [
...
{"name":"m_v_fairvalue5","index":"m_v_fairvalue5","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
{"name":"m_v_fairvalue4","index":"m_v_fairvalue4","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
{"name":"m_v_fairvalue3","index":"m_v_fairvalue3","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
{"name":"m_v_fairvalue2","index":"m_v_fairvalue2","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
{"name":"m_v_fairvalue1","index":"m_v_fairvalue1","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
/*
{hidden:true,"name":"m_growth_score","index":"m_growth_score","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
{hidden:true,"name":"m_growth_stars","index":"m_growth_stars","align":"center","sortable":true,"search":true,"stype":"between","editable":false},

{hidden:true,"name":"m_safety_score","index":"m_safety_score","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
{hidden:true,"name":"m_safety_stars","index":"m_safety_stars","align":"center","sortable":true,"search":true,"stype":"between","editable":false},

{hidden:true,"name":"m_cashflow_score","index":"m_cashflow_score","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
...
{hidden:true,"name":"m_moat_score","index":"m_moat_score","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
{hidden:true,"name":"m_moat_stars","index":"m_moat_stars","align":"center","sortable":true,"search":true,"stype":"between","editable":false},

{hidden:true,"name":"m_valuation_score","index":"m_valuation_score","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
...
{hidden:true,"name":"m_total_score","index":"m_total_score","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
*/
...
{"name":"m_v_fairvalue5_from","index":"m_v_fairvalue5_from","viewable":false,"hidden":true},
{"name":"m_v_fairvalue5_to","index":"m_v_fairvalue5_to","viewable":false,"hidden":true},
{"name":"m_v_fairvalue4_from","index":"m_v_fairvalue4_from","viewable":false,"hidden":true},
{"name":"m_v_fairvalue4_to","index":"m_v_fairvalue4_to","viewable":false,"hidden":true},
{"name":"m_v_fairvalue3_from","index":"m_v_fairvalue3_from","viewable":false,"hidden":true},
{"name":"m_v_fairvalue3_to","index":"m_v_fairvalue3_to","viewable":false,"hidden":true},
{"name":"m_v_fairvalue2_from","index":"m_v_fairvalue2_from","viewable":false,"hidden":true},
{"name":"m_v_fairvalue2_to","index":"m_v_fairvalue2_to","viewable":false,"hidden":true},
{"name":"m_v_fairvalue1_from","index":"m_v_fairvalue1_from","viewable":false,"hidden":true},
{"name":"m_v_fairvalue1_to","index":"m_v_fairvalue1_to","viewable":false,"hidden":true},
...
function update_status() {
    ...
    if(ids.length > 0) {
        var url = '/adminpanel/data/spider?mode=edit';
