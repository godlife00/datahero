...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		caption_html += "<a href='/adminpanel/main/analyze_detail' class='btn btn-danger btn-xs' style='float:right;margin-left:5px'>";
		...
		caption_html += "</a>";
         ...
         main_grid = jQuery("#jqgrid").jqGrid({
            ...
            sortname : 'an_id',
            url : "/adminpanel/main/analyze?mode=list",
            editurl : "/adminpanel/main/analyze?mode=edit",
            datatype : "json",
            ...
            colModel : [
                {"name":"an_id","index":"an_id","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
                {"name":"a_loginid","index":"a_loginid","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["eq"]},"editable":false},
                {"name":"an_ticker","index":"an_ticker","align":"center","sortable":true,"search":true,"searchoptions":{"sopt":["eq"]},"editable":false},
                {"name":"an_view_count","index":"an_view_count","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
                {"name":"an_is_active","index":"an_is_active","align":"center","sortable":true,"search":true,"stype":"select","searchoptions":{"sopt":["eq"],"value":"<?=$active_map_sel?>"},"editable":true,"edittype":"select","editoptions":{"sopt":["eq"],"value":"<?=$active_map?>"}, "width":"100"},
                {"name":"an_view_srv","index":"an_view_srv","align":"center","sortable":true,"search":true,"stype":"select","searchoptions":{"sopt":["eq"],"value":"<?=$view_srv_map_sel?>"},"editable":true,"edittype":"select","editoptions":{"sopt":["eq"],"value":"<?=$view_srv_map?>"}, "width":"100"},
                {"name":"an_display_date","index":"an_display_date","align":"center","sortable":true,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},
                {"name":"an_created_at","index":"an_created_at","align":"center","sortable":true,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},
                {"name":"an_updated_at","index":"an_updated_at","align":"center","sortable":true,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},
                {"name":"an_id_from","index":"an_id_from","viewable":false,"hidden":true},
                {"name":"an_id_to","index":"an_id_to","viewable":false,"hidden":true},
                {"name":"an_view_count_from","index":"an_view_count_from","viewable":false,"hidden":true},
                {"name":"an_view_count_to","index":"an_view_count_to","viewable":false,"hidden":true},
                {"name":"an_display_date_from","index":"an_display_date_from","viewable":false,"hidden":true},
                {"name":"an_display_date_to","index":"an_display_date_to","viewable":false,"hidden":true},
                {"name":"an_created_at_from","index":"an_created_at_from","viewable":false,"hidden":true},
                {"name":"an_created_at_to","index":"an_created_at_to","viewable":false,"hidden":true},
                {"name":"an_updated_at_from","index":"an_updated_at_from","viewable":false,"hidden":true},
                {"name":"an_updated_at_to","index":"an_updated_at_to","viewable":false,"hidden":true}
            ],
...
*/
            ...
            onCellSelect: function(id, cell_idx, cell_value){
				...
				var edit_url = '/adminpanel/main/analyze_detail/'+id;
...
jQuery("#jqgrid").jqGrid('navGrid', "#pjqgrid", {
			...
			// date picker
			var date_fields = ['an_display_date','an_created_at','an_updated_at']; 
...
function set_edit_datepicker(id) {
	var fields = ['an_display_date','an_created_at','an_updated_at']; 
...
function update_status() {
    ...
    if(ids.length > 0) {
        var url = '/adminpanel/main/analyze?mode=edit';
