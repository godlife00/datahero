                ...
                <div class="financecachart_area">
                    ...
                    <div class="chart_area">
                        <div class="box">
                            ...
                            SubSearchCharmFiChart1('containerfinance1_1', value, params, '<?=$ticker_currency;?>');
                            </script>
                        ...
                        <div class="box">
                            ...
                            SubSearchCharmFiChart7('containerfinance1_7', value, params, '<?=$ticker_currency;?>');
                            </script>
                            <!-- 종목검색 - 종목진단 - 재무 차트 id = containerfinance1 -->
                            <div class="summary_guide small">
                                <!-- div 사이즈는 big, small  -->
