...
// 서브 종목분석 TOP 차트
function SubAnalyTopChart(obj_id, value, params) {
    Highcharts.chart(obj_id, {
        chart: {
            type: 'line',
            renderTo: obj_id,
...
/* 매출과 이익 */
function SubSearchCharmFiChart1(obj_id, value, params, moneyunit='백만달러') {
    Highcharts.setOptions({
        lang: {
            thousandsSep: ','
        }
