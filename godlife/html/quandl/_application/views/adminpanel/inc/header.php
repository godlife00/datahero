<!DOCTYPE html>
<html lang="en-us" <?php  
function get_key_value_string($prop, $value) {
    if($prop == null || $value == null) {
        return '';
    }
    return $prop.'="'.$value.'"';
}
if(is_array($page_html_prop) && sizeof($page_html_prop) > 0) {
    echo  implode(' ', array_map('get_key_value_string', array_keys($page_html_prop), $page_html_prop)) ;
}
?>>
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?><?=SERVICE_NAME?> Admin Panel</title>
		...
		*/
		...
		<link rel="apple-touch-icon" href="<?php echo ASSETS_URL; ?>/img/favicon/favicon.png">
		...
		<script src="<?php echo ASSETS_URL; ?>/js/plugin/jquery-numeric/jquery.numeric.js"></script>
	...
	<body <?php 
if(is_array($page_html_prop) && sizeof($page_html_prop) > 0) {
    echo implode(' ', array_map('key_value_match', array_keys($page_body_prop), $page_body_prop)) ;
}
    ?>>
		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<span id="logo"> <a href="/adminpanel"><img src="<?php echo ASSETS_URL; ?>/img/logo-admin.png" alt="<?=SERVICE_NAME?>" style="width:150px;"></a> </span>
					...
					*/
					...
					<div class="pull-right">
						...
						<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
							<li class="">
								<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
									<img src="<?php echo ASSETS_URL; ?>/img/avatars/sunny.png" alt="<?=$sess_data['admin']['name']?>" class="online" />
									<span style='font-weight:bold;color:#339922;text-decoration:none;'><?=$sess_data['admin']['name']?></span>
								</a>
								<ul class="dropdown-menu pull-right">
									...
									*/
									?>
									<li>
										<a href="<?php echo APP_URL; ?>/adminpanel/account/logout" class="padding-10 padding-top-5 padding-bottom-5" data-action="userLogout"><i class="fa fa-sign-out fa-lg"></i> <strong><u>L</u>ogout</strong></a>
									</li>
								</ul>
							</li>
						</ul>
						...
						<script type="text/javascript">
						    ...
						    if(<?=($this->agent->is_mobile()) ? 'true' : 'false'?>) {
							view_type = 'M';
						...
						<!-- logout button -->
						<div id="logout" class="btn-header transparent pull-right" rel="tooltip" data-placement="bottom" title="Sign Out">
							<span> <a href="<?php echo APP_URL; ?>/adminpanel/account/logout" title="Sign Out" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
						...
						<form action="<?php echo APP_URL; ?>/search.php" class="header-search pull-right">
							<input type="text" name="param" placeholder="Find product and customer" id="search-fld">
							<button type="submit">
				...
				-->
				<?php if(false && $sess_data['admin']['level'] == '9') : ?>
				<div id="shortcut">
					<ul>
						<li>
							<a href="<?php echo APP_URL; ?>/adminpanel/sales/orders" class="jarvismetro-tile big-cubes bg-color-blue"> <span class="iconbox"> <i class="fa fa-credit-card fa-4x"></i> <span>Orders <?php /*<span class="label pull-right bg-color-darken">14</span>*/?></span> </span> </a>
						</li>
						<li>
							<a href="<?php echo APP_URL; ?>/adminpanel/products/lists" class="jarvismetro-tile big-cubes bg-color-orangeDark"> <span class="iconbox"> <i class="fa fa-barcode fa-4x"></i> <span>Products</span> </span> </a>
						</li>
						<li>
							<a href="<?php echo APP_URL; ?>/adminpanel/reports/orders" class="jarvismetro-tile big-cubes bg-color-purple"> <span class="iconbox"> <i class="fa fa-bar-chart-o fa-4x"></i> <span>Sales Orders</span> </span> </a>
						</li>
						<li>
							<a href="<?php echo APP_URL; ?>/adminpanel/reports/products_ordered" class="jarvismetro-tile big-cubes bg-color-purple"> <span class="iconbox"> <i class="fa fa-shopping-cart fa-4x"></i> <span>Products Ordered</span> </span> </a>
						</li>
						<li>
							<a href="<?php echo APP_URL; ?>/adminpanel/reports/customer_new_account" class="jarvismetro-tile big-cubes bg-color-purple"> <span class="iconbox"> <i class="fa fa-group fa-4x"></i> <span>New Account<?php /*<span class="label pull-right bg-color-darken">99</span>*/?></span> </span> </a>
						</li>
					</ul>
				</div>
				<?php endif; ?>
