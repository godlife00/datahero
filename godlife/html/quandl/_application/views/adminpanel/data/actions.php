...
$page_nav["data"]["sub"]["actions"]["active"] = true;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		var caption_html = "<b><i class='fa fa-table'>&nbsp;&nbsp;Data Actions</i></b>"; 
		

         main_grid = jQuery("#jqgrid").jqGrid({
            caption : caption_html,
            sortname : 'act_id',
            url : "/adminpanel/data/actions?mode=list",
            editurl : "/adminpanel/data/actions?mode=edit",
            datatype : "json",
            shrinkToFit:<?=($this->agent->is_mobile()) ? 'false' : 'true'?>,
            height : 'auto',
            colNames : ['Id','Date','Action','Ticker','Name','Value','Contraticker','Contraname','Created At','Updated At','Id_from','Id_to','Date_from','Date_to','Value_from','Value_to','Created At_from','Created At_to','Updated At_from','Updated At_to'],  
			jsonReader : {
			  id: "act_id",
		   	},
            colModel : [{"name":"act_id","index":"act_id","align":"center","sortable":true,"search":true,"stype":"between","editable":false},{"name":"act_date","index":"act_date","align":"center","sortable":true,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},{"name":"act_action","index":"act_action","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["eq"]},"editable":false},{"name":"act_ticker","index":"act_ticker","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["eq"]},"editable":false},{"name":"act_name","index":"act_name","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["cn"]},"editable":false},{"name":"act_value","index":"act_value","align":"center","sortable":false,"search":true,"stype":"between","editable":false},{"name":"act_contraticker","index":"act_contraticker","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["eq"]},"editable":false},{"name":"act_contraname","index":"act_contraname","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["cn"]},"editable":false},{"name":"act_created_at","index":"act_created_at","align":"center","sortable":true,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},{"name":"act_updated_at","index":"act_updated_at","align":"center","sortable":true,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},{"name":"act_id_from","index":"act_id_from","viewable":false,"hidden":true},{"name":"act_id_to","index":"act_id_to","viewable":false,"hidden":true},{"name":"act_date_from","index":"act_date_from","viewable":false,"hidden":true},{"name":"act_date_to","index":"act_date_to","viewable":false,"hidden":true},{"name":"act_value_from","index":"act_value_from","viewable":false,"hidden":true},{"name":"act_value_to","index":"act_value_to","viewable":false,"hidden":true},{"name":"act_created_at_from","index":"act_created_at_from","viewable":false,"hidden":true},{"name":"act_created_at_to","index":"act_created_at_to","viewable":false,"hidden":true},{"name":"act_updated_at_from","index":"act_updated_at_from","viewable":false,"hidden":true},{"name":"act_updated_at_to","index":"act_updated_at_to","viewable":false,"hidden":true}],
...
jQuery("#jqgrid").jqGrid('navGrid', "#pjqgrid", {
			...
			// date picker
			var date_fields = ['act_date','act_created_at','act_updated_at']; 
...
function set_edit_datepicker(id) {
	var fields = ['act_date','act_created_at','act_updated_at']; 
...
function update_status() {
    ...
    if(ids.length > 0) {
        var url = '/adminpanel/data/actions?mode=edit';
