            ...
            <div class="schChartArea">
                <div class="chartDate">
					...
					<div class="invest_charm_b ic_pc imsi_div">
						...
						<a href="http://dev.toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_main/service" target="_blank" class="show_pop">분석보기<i></i></a>
					</div>
...
?>
            <div class="tableData bannerRight">
				...
				<div class="alliance_banner ab_mobile imsi_div">
					...
					<a href="http://dev.toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_stock/recommend" class="link_btn" target="_blank">종목추천 확인하기<i></i></a>
				</div>
				...
				<div class="alliance_banner ab_mobile imsi_div">
					...
					<a href="http://dev.toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_stock/recommend_view/<?=$up_banner['rc_id']?>" class="e_link_btn" target="_blank">투자전략 확인하기<i></i></a>
				</div>
				<?php else :?>
				<div class="alliance_banner ab_mobile imsi_div">
					...
					<a href="http://dev.toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_attractiveness/attractive?sort=total&netincome=all&marketcap=over100billion" class="j_link_btn" target="_blank">투자매력 종목 더보기<i></i></a>
				</div>
				<?php endif;?>
				<!-- 제휴사 배너 -->
            </div>
