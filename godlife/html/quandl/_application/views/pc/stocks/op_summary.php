    ...
    ?>            
            ...
            <div class="schChartArea">
                ...
                <div class="top5">
                    <a href="/op_stocks/competitors/<?=$ticker_code?>" class="more"><img src="/img/icon/more.png" alt="더보기"></a>

                    <?php foreach(array_values($industry_top_seps) as $idx => $itop_sep) : if($idx >= 5) break; ?>
                    <dl class="list">
                        <dt><a href='/op_stocks/summary/<?=$itop_sep['ticker']?>'><?=$itop_sep['ticker']?></a></dt>
