                ...
                <div class="standard">
                    <div class="select open">
                        ...
                        <ul class="a_list">
                            ...
                            <li><a href="javascript:location.href='/wm_stocks/trends?selected_sec=<?=$sec?>'"><?=$sec?></a></li>
                ...
                <div class="table_left">
                    ...
                    <table cellspacing="0" border="1" class="tableColtype trends">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="title"><a href="/wm_stocks/summary/<?=$rise['tkr_ticker']?>"><?=$rise['tkr_name']?><span
                ...
                <div class="table_right">
                    ...
                    <table cellspacing="0" border="1" class="tableColtype trends">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="title"><a href="/wm_stocks/summary/<?=$fall['tkr_ticker']?>"><?=$fall['tkr_name']?><span
            ...
            $(document).ready(function(){
                ...
                window.parent.postMessage({ childData : ' trends ' }, '*'); 
            });
            </script>