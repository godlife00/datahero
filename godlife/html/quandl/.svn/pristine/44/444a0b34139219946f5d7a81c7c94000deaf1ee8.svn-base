    ...
    <!-- //schChartTitle -->            
    <ul class="tabs">                
        <li rel="tab1"<?=$active_menu == 'summary' ? ' class="active"' : ''?> onclick="location.href='/op_stocks/summary/<?=$ticker_code?>'">요약</li>
        <li rel="tab2"<?=$active_menu == 'invest' ? ' class="active"' : ''?> onclick="location.href='/op_stocks/invest/<?=$ticker_code?>'">투자지표</li>
        <li rel="tab3"<?=$active_menu == 'financials' ? ' class="active"' : ''?> onclick="location.href='/op_stocks/financials/<?=$ticker_code?>'">재무제표</li>
        <li rel="tab6"<?=$active_menu == 'competitors' ? ' class="active"' : ''?> onclick="location.href='/op_stocks/competitors/<?=$ticker_code?>'">경쟁사</li>
        <li rel="tab5"<?=$active_menu == 'financial_chart' ? ' class="active"' : ''?> onclick="location.href='/op_stocks/financial_chart/<?=$ticker_code?>'">재무차트</li>
    </ul>
