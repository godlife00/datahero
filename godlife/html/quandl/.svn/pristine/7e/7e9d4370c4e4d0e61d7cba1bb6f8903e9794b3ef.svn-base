...
abstract class BasePC_Controller extends CI_Controller {
...
*/
        ...
        foreach($ticker_list as $t => $row) {
            ...
            if(isset($comp_list_new[$t])) {
                $txt['name'] .= ' '.$comp_list_new[$t]['cp_korname'];
            }
...
*/		
    ...
    public function _view($view, $data=array(), $return_contents = false){
        ...
        if( ! $return_contents) {
            ...
            $this->load->view('/pc/'.$view.'.php', $data); 
            $this->load->view('/pc/inc/footer.php', $footer);
        } else {
            $result  = $this->load->view('/pc/inc/header.php', $header, true)."\n";
            $result .= $this->load->view('/pc/'.$view.'.php', $data, true)."\n"; 
            $result .= $this->load->view('/pc/inc/footer.php', $footer, true)."\n";
            return $result;
        }
    }

    public function wm_view($view, $data=array(), $return_contents = false){
        //$data['sess_data'] = $this->session->all_userdata();
        ...
        if( ! $return_contents) {
            $this->load->view('/pc/inc/wm_header.php', $header);
            $this->load->view('/pc/'.$view.'.php', $data); 
            $this->load->view('/pc/inc/wm_footer.php', $footer);
        } else {
            $result  = $this->load->view('/pc/inc/wm_header.php', $header, true)."\n";
            $result .= $this->load->view('/pc/'.$view.'.php', $data, true)."\n"; 
            $result .= $this->load->view('/pc/inc/wm_footer.php', $footer, true)."\n";
            return $result;
        }
    }

    public function op_view($view, $data=array(), $return_contents = false){
        //$data['sess_data'] = $this->session->all_userdata();
        ...
        if( ! $return_contents) {
            $this->load->view('/pc/inc/op_header.php', $header);
            $this->load->view('/pc/'.$view.'.php', $data); 
            $this->load->view('/pc/inc/op_footer.php', $footer);
        } else {
            $result  = $this->load->view('/pc/inc/op_header.php', $header, true)."\n";
            $result .= $this->load->view('/pc/'.$view.'.php', $data, true)."\n"; 
            $result .= $this->load->view('/pc/inc/op_footer.php', $footer, true)."\n";
            return $result;
        }
    }
