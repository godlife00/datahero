...
require_once dirname(__FILE__).'/px_base_pc.php';
class Px_stocks extends Px_BasePC_Controller{
	...
	{
        $this->common->locationhref('/px_stocks/summary');
		exit;
	}
...
*/
    ...
    public function ajax_save_search_history() {
        ...
        if(isset($this->ticker_info_map[$ticker])) {
			...
			$search_url = CS_URL.'/main/ajax_save_search_history/P?ticker='.$ticker;
