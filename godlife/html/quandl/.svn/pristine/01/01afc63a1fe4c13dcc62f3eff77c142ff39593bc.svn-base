...
require_once dirname(__FILE__).'/x1_base_pc.php';
class X1_stocks extends X1_BasePC_Controller{
	...
	{
        $this->common->locationhref('/x1_stocks/summary');
		exit;
	}
...
*/
    ...
    public function ajax_save_search_history() {
        ...
        if(isset($this->ticker_info_map[$ticker])) {
			...
			$search_url = CS_URL.'/main/ajax_save_search_history/X?ticker='.$ticker;
