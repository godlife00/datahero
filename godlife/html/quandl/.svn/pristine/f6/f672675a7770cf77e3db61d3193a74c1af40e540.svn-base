...
$page_nav["data"]["sub"]["indicator"]["active"] = true;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		var caption_html = "<b><i class='fa fa-table'>&nbsp;&nbsp;Data Indicator</i></b>"; 
		

         main_grid = jQuery("#jqgrid").jqGrid({
            caption : caption_html,
            sortname : 'idc_id',
            url : "/adminpanel/data/indicator?mode=list",
            editurl : "/adminpanel/data/indicator?mode=edit",
            datatype : "json",
            shrinkToFit:<?=($this->agent->is_mobile()) ? 'false' : 'true'?>,
            height : 'auto',
            colNames : ['Id','Table','Indicator','Isfilter','Isprimarykey','Title','Description','Unittype','Created At','Updated At','Id_from','Id_to','Created At_from','Created At_to','Updated At_from','Updated At_to'],  
			jsonReader : {
			  id: "idc_id",
		   	},
            colModel : [
	    {"name":"idc_id","index":"idc_id","align":"center","sortable":true,"search":true,"stype":"between","editable":false},
	    {"name":"idc_table","index":"idc_table","align":"center","sortable":true,"search":true,"searchoptions":{"sopt":["eq"]},"editable":false},
	    {"name":"idc_indicator","index":"idc_indicator","align":"center","sortable":true,"search":true,"searchoptions":{"sopt":["cn"]},"editable":false},
	    {"name":"idc_isfilter","index":"idc_isfilter","align":"center","sortable":true,"search":true,"stype":"select","searchoptions":{"sopt":["eq"],"value":":;N:N;Y:Y"},"editable":false},
	    {"name":"idc_isprimarykey","index":"idc_isprimarykey","align":"center","sortable":true,"search":true,"stype":"select","searchoptions":{"sopt":["eq"],"value":":;N:N;Y:Y"},"editable":false},
	    {"name":"idc_title","index":"idc_title","align":"center","sortable":true,"search":true,"searchoptions":{"sopt":["cn"]},"editable":false},
	    {"name":"idc_description","index":"idc_description","align":"center","sortable":true,"search":true,"searchoptions":{"sopt":["cn"]},"editable":false},
	    {"name":"idc_unittype","index":"idc_unittype","align":"center","sortable":true,"search":true,"searchoptions":{"sopt":["cn"]},"editable":false},
	    {"name":"idc_created_at","index":"idc_created_at","align":"center","sortable":true,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},
	    {"name":"idc_updated_at","index":"idc_updated_at","align":"center","sortable":true,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},
	    {"name":"idc_id_from","index":"idc_id_from","viewable":false,"hidden":true},
	    {"name":"idc_id_to","index":"idc_id_to","viewable":false,"hidden":true},
	    {"name":"idc_created_at_from","index":"idc_created_at_from","viewable":false,"hidden":true},
	    {"name":"idc_created_at_to","index":"idc_created_at_to","viewable":false,"hidden":true},
	    {"name":"idc_updated_at_from","index":"idc_updated_at_from","viewable":false,"hidden":true},
	    {"name":"idc_updated_at_to","index":"idc_updated_at_to","viewable":false,"hidden":true}],
...
jQuery("#jqgrid").jqGrid('navGrid', "#pjqgrid", {
			...
			// date picker
			var date_fields = ['idc_created_at','idc_updated_at']; 
...
function set_edit_datepicker(id) {
	var fields = ['idc_created_at','idc_updated_at']; 
...
function update_status() {
    ...
    if(ids.length > 0) {
        var url = '/adminpanel/data/indicator?mode=edit';
