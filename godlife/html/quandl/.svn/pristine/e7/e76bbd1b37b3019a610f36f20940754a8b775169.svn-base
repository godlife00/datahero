    <div class="schChartTitle">
		...
		<div>
			...
			<ul class="info">
				...
				<li class="category"><a href="https://toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_stock/recipe/dividend">배당매력주</a></li>
				<?php endif; ?>
				<?php if($mri_data['m_biz_growth_score'] >= 16) : ?>
				<li class="category"><a href="https://toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_stock/recipe/growth">이익성장</a></li>
				<?php endif; ?>
				<?php if($mri_data['m_biz_moat_score'] >= 16) : ?>
				<li class="category"><a href="https://toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_stock/recipe/moat">소비자독점주</a></li>
				<?php endif; ?>
			</ul>
			<!-- //info -->
		</div>
		...
		<ul class="info_icon">
			...
			<?php if($mri_data['m_biz_dividend_score'] >= 16) : ?>
			<li><a href="https://toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_stock/recipe/dividend">배당매력주</a></li>
			<?php endif; ?>
			<?php if($mri_data['m_biz_growth_score'] >= 16) : ?>
			<li><a href="https://toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_stock/recipe/growth">이익성장</a></li>
			<?php endif; ?>
			<?php if($mri_data['m_biz_moat_score'] >= 16) : ?>
			<li><a href="https://toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_stock/recipe/moat">소비자독점주</a></li>
			<?php endif; ?>
		</ul>
		...
		<div class="alliance_banner ab_pc imsi_div">
			...
			<a href="https://toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_stock/recommend" class="link_btn" target="_blank">종목추천 확인하기<i></i></a>
		</div>
		...
		<div class="alliance_banner ab_pc imsi_div">
			...
			<a href="https://toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_stock/recommend_view/<?=$up_banner['rc_id']?>" class="e_link_btn" target="_blank">투자전략 확인하기<i></i></a>
		</div>
		<?php else :?>
		<div class="alliance_banner ab_pc imsi_div">
			...
			<a href="https://toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_attractiveness/attractive?sort=total&netincome=all&marketcap=over100billion" class="j_link_btn" target="_blank">투자매력 종목 더보기<i></i></a>
		</div>
		<?php endif;?>
		<!-- 제휴사 배너 -->
    </div>
	...
	<div class="invest_charm_b ic_mobile imsi_div">
		...
		<a href="https://toogo.kr/mobile/foreign.tg?action=datahero&link=/x1_main/service" target="_blank" class="show_pop">분석보기<i></i></a>
	</div>
