...
$page_nav["data"]["sub"]["sp500"]["active"] = true;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		var caption_html = "<b><i class='fa fa-table'>&nbsp;&nbsp;Data Sp500</i></b>"; 
		

         main_grid = jQuery("#jqgrid").jqGrid({
            caption : caption_html,
            sortname : 'sp5_id',
            url : "/adminpanel/data/sp500?mode=list",
            editurl : "/adminpanel/data/sp500?mode=edit",
            datatype : "json",
            shrinkToFit:<?=($this->agent->is_mobile()) ? 'false' : 'true'?>,
            height : 'auto',
            colNames : ['Id','Date','Action','Ticker','Name','Contraticker','Contraname','Note','Created At','Updated At','Id_from','Id_to','Date_from','Date_to','Created At_from','Created At_to','Updated At_from','Updated At_to'],  
			jsonReader : {
			  id: "sp5_id",
		   	},
            colModel : [{"name":"sp5_id","index":"sp5_id","align":"center","sortable":true,"search":true,"stype":"between","editable":false},{"name":"sp5_date","index":"sp5_date","align":"center","sortable":true,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},{"name":"sp5_action","index":"sp5_action","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["eq"]},"editable":false},{"name":"sp5_ticker","index":"sp5_ticker","align":"center","sortable":true,"search":true,"searchoptions":{"sopt":["eq"]},"editable":false},{"name":"sp5_name","index":"sp5_name","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["cn"]},"editable":false},{"name":"sp5_contraticker","index":"sp5_contraticker","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["eq"]},"editable":false},{"name":"sp5_contraname","index":"sp5_contraname","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["cn"]},"editable":false},{"name":"sp5_note","index":"sp5_note","align":"center","sortable":false,"search":true,"searchoptions":{"sopt":["cn"]},"editable":false},{"name":"sp5_created_at","index":"sp5_created_at","align":"center","sortable":true,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},{"name":"sp5_updated_at","index":"sp5_updated_at","align":"center","sortable":true,"search":true,"stype":"between","attr":"onchange=\"jqgrid.triggerToolbar();\"","editable":false},{"name":"sp5_id_from","index":"sp5_id_from","viewable":false,"hidden":true},{"name":"sp5_id_to","index":"sp5_id_to","viewable":false,"hidden":true},{"name":"sp5_date_from","index":"sp5_date_from","viewable":false,"hidden":true},{"name":"sp5_date_to","index":"sp5_date_to","viewable":false,"hidden":true},{"name":"sp5_created_at_from","index":"sp5_created_at_from","viewable":false,"hidden":true},{"name":"sp5_created_at_to","index":"sp5_created_at_to","viewable":false,"hidden":true},{"name":"sp5_updated_at_from","index":"sp5_updated_at_from","viewable":false,"hidden":true},{"name":"sp5_updated_at_to","index":"sp5_updated_at_to","viewable":false,"hidden":true}],
...
jQuery("#jqgrid").jqGrid('navGrid', "#pjqgrid", {
			...
			// date picker
			var date_fields = ['sp5_date','sp5_created_at','sp5_updated_at']; 
...
function set_edit_datepicker(id) {
	var fields = ['sp5_date','sp5_created_at','sp5_updated_at']; 
...
function update_status() {
    ...
    if(ids.length > 0) {
        var url = '/adminpanel/data/sp500?mode=edit';
