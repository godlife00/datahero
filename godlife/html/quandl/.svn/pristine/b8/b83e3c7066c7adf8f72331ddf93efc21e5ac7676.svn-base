...
abstract class Ge_BasePC_Controller extends CI_Controller {
...
/*
    public function _view($view, $data=array(), $return_contents = false){
        ...
        if( ! $return_contents) {
            $this->load->view('/ge/inc/header.php', $header);
            $this->load->view('/ge/'.$view.'.php', $data); 
            $this->load->view('/ge/inc/footer.php', $footer);
        } else {
            $result  = $this->load->view('/ge/inc/header.php', $header, true)."\n";
            $result .= $this->load->view('/ge/'.$view.'.php', $data, true)."\n"; 
            $result .= $this->load->view('/ge/inc/footer.php', $footer, true)."\n";
            return $result;
        }
    }
*/
